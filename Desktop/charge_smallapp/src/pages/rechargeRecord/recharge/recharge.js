  ...
  render() {
    ...
    return (
      <View className='recharge'>
       ...
       <View className='mb'>
       <View className='mbl'>充值金额 </View>
       <Input onFocus={this.getInputValue} type='number' value={this.state.value} placeholder='请输入充值金额' maxLength='10' bindinput='getInputValue'  onbindinput={this.getInputValue} />
       </View>
       <View className='mbb' onClick={this.toCourse}>不会用 ？</View>
       <View className='bt' onTouchStart={this.getRrecharge}>微信充值</View>
      </View>
    )
  }
}
